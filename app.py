...
def display_excel_info():
    ...
    file_path = "D:\Problem Statement\iris.csv"
    ...
    return render_template('index.html', selected_graphs=selected_graphs, dataset=dataset, categorized_columns=categorized_columns)
